import { FaEnvelope, FaUserGraduate, FaUserCircle } from "react-icons/fa";
  ...
  return (
    <div className="min-h-screen bg-[#070B08] flex items-center justify-center px-6">
      ...
      <div className="relative w-full max-w-md rounded-3xl border border-green-500/10 bg-white/5 p-8 backdrop-blur-xl">
        ...
        {/* Button */}
        <button
          className="mt-8 w-full rounded-xl bg-green-500 py-3 font-semibold text-black transition hover:bg-green-400"
        >
          Edit Profile
        </button>
